...
GameManager.prototype.setup = function (useSize) {
  ...
  if (previousState) {
    this.size_x = previousState.grid.size_x;
    this.size_y = previousState.grid.size_y;
  ...
  this.actuator.createGrid(this.size_x, this.size_y);
...
GameManager.prototype.actuate = function () {
  if (this.storageManager.getBestScore(this.size_x, this.size_y) < this.score) {
    this.storageManager.setBestScore(this.score, this.size_x, this.size_y);
  }
  ...
  this.actuator.actuate(this.grid, {
    ...
    over:       this.over,
    won:        this.won,
    bestScore:  this.storageManager.getBestScore(this.size_x, this.size_y),
